...
func GetOne(ctx context.Context, objId *primitive.ObjectID) (*mongocontrol.CardData, error) {
...
func AddOne(ctx context.Context, card *mongocontrol.CardData) (string, error) {
	var result string
	collection := cli.Mgo.MgoClient.Database("control").Collection("card_data")
	document := bson.D{
